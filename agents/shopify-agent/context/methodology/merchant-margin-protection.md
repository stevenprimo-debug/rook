...
- Companion methodology: `agents/shopify-agent/context/methodology/customer-trust-pattern.md`
- Related agent: `agents/finance-manager/context/methodology/accounting-framework.md`
