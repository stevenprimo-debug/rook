...
The bench-of-three principles (Speed / Polish / Conversion) defines WHAT this
...
| File | Purpose |
|---|---|
| `_default.md` | Out-of-box voice — ship-first developer, conversion-metric-anchored. Active when `{voice_mode}` is unset. |
...
Voice modes do NOT change the bench. Speed / Polish / Conversion runs underneath
