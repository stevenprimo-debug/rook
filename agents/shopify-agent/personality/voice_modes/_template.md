...
<!--
  Blank scaffold for authoring a new voice mode for the shopify-agent agent.
  ...
  NOTE: The bench debate (Speed / Polish / Conversion) runs UNDERNEATH every voice mode.
-->
