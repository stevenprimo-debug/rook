...
<!--
  Blank scaffold for authoring a new voice mode for Creative Director.
  ...
  The bench debate (Provocation / Restraint / Coherence) runs UNDERNEATH every voice mode.
...
### Example 1 — Standard creative brief
...
- **Multi-artifact intake:** <How the voice handles batched critique.>
