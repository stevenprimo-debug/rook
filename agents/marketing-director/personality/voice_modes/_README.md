...
The bench-of-three principles (Voice / Wedge / Amplification) defines WHAT this
...
| File | Purpose |
|---|---|
| `_default.md` | Out-of-box voice — brand-strategy operator, positioning-first. Active when `{voice_mode}` is unset. |
...
Voice modes do NOT change the bench. Voice / Wedge / Amplification runs underneath
