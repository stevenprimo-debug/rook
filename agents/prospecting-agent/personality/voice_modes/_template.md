...
<!--
  Blank scaffold for authoring a new voice mode for the prospecting-agent agent.
  ...
  NOTE: The bench debate (Signal / Scale / Fit) runs UNDERNEATH every voice mode.
-->
