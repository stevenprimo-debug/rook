...
- Wikilinks (`[[client_project_facts]]`) — explicit references.
...
- Companion methodology: `.claude/reference/methodology/librarian-compounding-append-pattern.md`
- Vendored reference: `.claude/reference/anthropic-ama-architecture.md`
